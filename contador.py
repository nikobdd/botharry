...
async def on_message(message):
    if message.content.startswith('dpcontador'):
     if message.author.server_permissions.administrator:
        ...
        if '{}'.format(set1) == 'on':
         ...
         if message.server.id in texto:
          ...
          await client.edit_channel(message.channel, topic="<a:picafeliz:489822390151282693> Membros: " + str(numeros).replace("setar-zero","<:zero:485136919186112512>").replace("setar-um", "<:um:485136919144169472>").replace("setar-dois","<:dois:485136914069061632>").replace("setar-tres", "<:tres:485136919110483994>").replace("setar-quatro", "<:quatro:485136913968136192>").replace("setar-cinco", "<:cinco:485136914144559104>").replace("setar-seis","<:seis:485136913896833026>").replace("setar-sete", "<:Sete:485136918649110539>").replace("setar-oito","<:oito:485136914047959040>").replace("setar-nove", "<:nove:485136913934843915>") + ' {}'.format(str(texto[message.server.id]['texto'])))
          contador[message.server.id] = {'serverid': '{}'.format(message.server.id), 'canalid': '{}'.format(message.channel.id), 'conta-at': 0}
         else:
          numeros = str(len(message.server.members)).replace("0", "setar-zero").replace("1", "setar-um").replace("2","setar-dois").replace("3", "setar-tres").replace("4", "setar-quatro").replace("5", "setar-cinco").replace("6","setar-seis").replace("7", "setar-sete").replace("8", "setar-oito").replace("9", "setar-nove")
          await client.edit_channel(message.channel, topic="<a:picafeliz:489822390151282693> Membros: " + str(numeros).replace("setar-zero", "<:zero:485136919186112512>").replace("setar-um","<:um:485136919144169472>").replace("setar-dois", "<:dois:485136914069061632>").replace("setar-tres","<:tres:485136919110483994>").replace("setar-quatro", "<:quatro:485136913968136192>").replace("setar-cinco","<:cinco:485136914144559104>").replace("setar-seis", "<:seis:485136913896833026>").replace("setar-sete","<:Sete:485136918649110539>").replace("setar-oito", "<:oito:485136914047959040>").replace("setar-nove","<:nove:485136913934843915>"))
          contador[message.server.id] = {'serverid': '{}'.format(message.server.id),'canalid': '{}'.format(message.channel.id), 'conta-at': 0}
        if '{}'.format(set1) == 'off':
        ...
        if '{}'.format(set1) == '':
         ...
         embed.set_thumbnail(url="https://cdn.discordapp.com/emojis/485124116358365204.gif?v=1")
    ...
    if message.content.startswith('dpcontador editar'):
     if message.author.server_permissions.administrator:
        with open('contador.json', 'r') as f:
            contador = json.load(f)
        with open('texto.json', 'r') as f:
        ...
        if '{}'.format(set1) == '':
         ...
         if contador[message.server.id]['conta-at'] == 0:
          ...
          canaleditar = client.get_channel(iddocanal)
          numeros = str(len(message.server.members)).replace("0", "setar-zero").replace("1", "setar-um").replace("2","setar-dois").replace("3", "setar-tres").replace("4", "setar-quatro").replace("5", "setar-cinco").replace("6","setar-seis").replace("7", "setar-sete").replace("8", "setar-oito").replace("9", "setar-nove")
          await client.edit_channel(canaleditar, topic="<a:picafeliz:489822390151282693> Membros: " + str(numeros).replace("setar-zero", "<:zero:485136919186112512>").replace("setar-um","<:um:485136919144169472>").replace("setar-dois", "<:dois:485136914069061632>").replace("setar-tres","<:tres:485136919110483994>").replace("setar-quatro", "<:quatro:485136913968136192>").replace("setar-cinco","<:cinco:485136914144559104>").replace("setar-seis", "<:seis:485136913896833026>").replace("setar-sete", "<:Sete:485136918649110539>").replace("setar-oito", "<:oito:485136914047959040>").replace("setar-nove", "<:nove:485136913934843915>") + ' {}'.format(str(texto[message.server.id]['texto'])))
...
client.run("NDg1MjIzOTM3MDgxMzQ0MDI3.Dqa_2Q.QanNR9JsTIjQiuiAaBO944fhptg")