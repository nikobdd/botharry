...
async def on_member_join(member):
  ...
  embed1.set_footer(text=client.user.name, icon_url=client.user.avatar_url)
  embed1 = discord.Embed ( title="<:hogwarts2:484155389470965760> Escola de Magia e Bruxaria De Hogwarts <:hogwarts2:484155389470965760>\n", url="", color=0x474545,description='***Coordenadores das casas Grifinória, Sonserina, Lufa lufa, Corvinal***\n  Prezado(a) {}'.format(member.mention))
